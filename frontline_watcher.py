...
async def main():
    ...
    if not username or not password:
        ...
        print()
        print("If code was cloned to a new instance/account, then it's very likely that the issue is that a .env file is still needed with the three variables required from the code (see the .env file from the account cloned for a template, but put in the new values)")
